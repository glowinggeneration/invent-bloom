 ...
 * original's navy/teal/yellow gradient to SMAIT's red brand family;
 * mechanics (the animated conic-gradient sweep) unchanged.
 */
  ...
  return (
    <div className="relative inline-block">
      <style>{`
        ...
        @property --rg-color-1 { syntax: '<color>'; initial-value: #1a0006; inherits: false; }
        @property --rg-color-2 { syntax: '<color>'; initial-value: #7a1230; inherits: false; }
        @property --rg-color-3 { syntax: '<color>'; initial-value: #c81e42; inherits: false; }
        @property --rg-color-4 { syntax: '<color>'; initial-value: #ff9eb0; inherits: false; }
        ...
        @property --rg-border-color-1 { syntax: '<color>'; initial-value: hsla(350, 75%, 90%, 0.7); inherits: true; }
        @property --rg-border-color-2 { syntax: '<color>'; initial-value: hsla(350, 50%, 90%, 0.25); inherits: true; }
        ...
        .rg-button:not(:disabled):hover {
          ...
          --rg-border-color-1: hsla(340, 75%, 90%, 0.1);
          --rg-border-color-2: hsla(340, 50%, 90%, 0.35);
