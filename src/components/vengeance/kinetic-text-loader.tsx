 ...
 * source https://github.com/Ashutoshx7/VengeanceUI. Unchanged. Note: the
 * per-letter animations (index 0 'L', index 4 'i') are hand-tuned for the
 * default text "Loading" specifically - passing a different `text` will
 * apply those animations to the wrong letters. Use the default.
 */
            ...
            if (index === 0 && char.toUpperCase() === "L") {
              return (
                <span
                  ...
                  style={{
                    animation: "ktl-l-bounce 1800ms cubic-bezier(0.25,0.25,0.75,0.75) infinite",
                  }}
                >
                  {char}
                </span>
            ...
            if (index === 4 && char.toLowerCase() === "i") {
              return (
                <span
                  ...
                  style={{
                    animation:
                      "ktl-letterStretch 1800ms cubic-bezier(0.25,0.23,0.73,0.75) infinite",
                  }}
                >
                  {char === "i" ? "ı" : char}
                </span>
