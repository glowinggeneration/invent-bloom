 ...
 * source https://github.com/Ashutoshx7/VengeanceUI. Unchanged - fully
 * self-contained, no framer-motion dependency. Pass `accentColor` at the
 * call site to match this app's brand tokens instead of the default neon
 * yellow.
 */
...
export function CornerButton({
  ...
  const resolvedIcon = icon ?? (showIcon ? <PencilIcon className="corner-btn-svg" /> : null);
  ...
  return (
    ...
    >
      ...
      <button className={cn("corner-btn", className)} style={style} {...props}>
