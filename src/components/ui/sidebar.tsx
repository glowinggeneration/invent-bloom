...
// Desktop 288px / mobile drawer capped 304px / compact icon rail 80px —
// see docs/build-standards (SMAIT sidebar UI/UX implementation spec).
      ...
      return (
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          <SheetContent
            ...
            data-mobile="true"
            className="w-(--sidebar-width) max-w-[min(88vw,19rem)] bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
            style={
              {
    ...
    return (
      ...
      >
        ...
        >
          <div
            data-sidebar="sidebar"
            className="flex h-full w-full flex-col bg-sidebar/80 backdrop-blur-xl backdrop-saturate-150 group-data-[variant=floating]:rounded-lg group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
          >
            {children}
          </div>
        </div>
